...
plot(ACopy.t_plot(2:A.counter-1),ACopy.Y_ref_plot(2:A.counter-1),'b','linewidth',2)
plot(ACopy.t_plot(2:A.counter-1),ACopy.Y_plot(2:A.counter-1),'r','linewidth',2)
% plot(A.t_plot(1:A.counter),A.Y_dis_plot(1:A.counter),'g')
% plot(A.t_plot(1:A.counter),A.Y_kalman_plot(1:A.counter),'color',[1 .4 .8])
a=legend('Y_{ref}','Y_{actual}')
set(a,'fontsize',16)
grid on
